...
module l2_axi_bus_interface(
    ...
    assign axi_bus.m_awburst = 2'b01;
    assign axi_bus.m_arburst = 2'b01;
        ...
        unique case (state_ff)
            ...
            begin
                ...
                begin
                    ...
                    burst_offset_nxt = burst_offset_ff + 4'(1);
                end
            end
    ...
    begin : update
        ...
        begin
            ...
            axi_bus.m_wlast <= state_nxt == STATE_WRITE_TRANSFER
                && axi_bus.s_wready
                && burst_offset_ff == 4'(BURST_BEATS) - 2;
        end
    end
