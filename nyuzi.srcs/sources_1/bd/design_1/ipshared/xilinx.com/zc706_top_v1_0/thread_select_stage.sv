        ...
        begin : thread_logic_gen
            ...
            begin
                ...
                case (thread_instr[thread_idx].pipeline_sel)
                    2'b01: writeback_conflict = writeback_allocate[0];
                    2'b00: writeback_conflict = writeback_allocate[1];
    ...
    begin
        ...
        begin
            case (issue_instr.pipeline_sel)
                2'b10: writeback_allocate_nxt[3] = 1'b1;
                2'b00: writeback_allocate_nxt[0] = 1'b1;
                default:
                    ;
            endcase
        end
