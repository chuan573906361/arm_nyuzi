...
//    PIPE_MCYCLE_ARITH
//} pipeline_sel_t;
typedef logic [1:0] pipeline_sel_t;
//`define PIPE_MEM 2'b00
//`define PIPE_SCYCLE_ARITH 2'b01
//`define PIPE_MCYCLE_ARITH 2'b10
...
typedef logic[4:0] control_register_t;
typedef enum logic[3:0] {
    TT_RESET                = 4'd0,
...
//} axi_burst_type_t;
typedef logic [1:0] axi_burst_type_t;
